...
var responseTimeDistributionInfos = {
        data: {"result": {"minY": 187903.0, "minX": 0.0, "maxY": 187903.0, "series": [{"data": [[0.0, 187903.0]], "isOverall": false, "label": "GET dostępne urządzenia", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 100, "maxX": 4.9E-324, "title": "Response Time Distribution"}},
        getOptions: function() {
...
var syntheticResponseTimeDistributionInfos = {
        data: {"result": {"minY": 187903.0, "minX": 0.0, "ticks": [[0, "Requests having \nresponse time <= 500ms"], [1, "Requests having \nresponse time > 500ms and <= 1,500ms"], [2, "Requests having \nresponse time > 1,500ms"], [3, "Requests in error"]], "maxY": 187903.0, "series": [{"data": [[0.0, 187903.0]], "color": "#9ACD32", "isOverall": false, "label": "Requests having \nresponse time <= 500ms", "isController": false}, {"data": [], "color": "yellow", "isOverall": false, "label": "Requests having \nresponse time > 500ms and <= 1,500ms", "isController": false}, {"data": [], "color": "orange", "isOverall": false, "label": "Requests having \nresponse time > 1,500ms", "isController": false}, {"data": [], "color": "#FF6347", "isOverall": false, "label": "Requests in error", "isController": false}], "supportsControllersDiscrimination": false, "maxX": 4.9E-324, "title": "Synthetic Response Times Distribution"}},
        getOptions: function() {
            return {
                legend: {
                    noColumns: 2,
...
var activeThreadsOverTimeInfos = {
        data: {"result": {"minY": 18.972020990656333, "minX": 1.78955616E12, "maxY": 19.997496747185608, "series": [{"data": [[1.78955622E12, 19.997496747185608], [1.78955616E12, 18.972020990656333]], "isOverall": false, "label": "Thread Group", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.78955622E12, "title": "Active Threads Over Time"}},
        getOptions: function() {
            return {
                series: {
                    stack: true,
...
var timeVsThreadsInfos = {
        data: {"result": {"minY": 1.1969696969696964, "minX": 1.0, "maxY": 6.3106025462604, "series": [{"data": [[2.0, 1.1969696969696964], [8.0, 2.5939553219448115], [9.0, 2.898039215686278], [10.0, 3.2425032594524112], [11.0, 3.527061855670106], [3.0, 1.2753108348135003], [12.0, 3.8339768339768328], [13.0, 4.102661596958172], [14.0, 4.384130982367756], [15.0, 4.728301886792457], [1.0, 1.5966386554621848], [4.0, 1.4645550527903464], [16.0, 4.976160602258473], [17.0, 5.347553324968631], [18.0, 5.657395701643492], [19.0, 6.164921465968588], [5.0, 1.7291960507757391], [20.0, 6.3106025462604], [6.0, 2.065187239944521], [7.0, 2.319999999999997]], "isOverall": false, "label": "GET dostępne urządzenia", "isController": false}, {"data": [[19.35790806958907, 6.114750695837784]], "isOverall": false, "label": "GET dostępne urządzenia-Aggregated", "isController": false}], "supportsControllersDiscrimination": true, "maxX": 20.0, "title": "Time VS Threads"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var bytesThroughputOverTimeInfos = {
        data : {"result": {"minY": 159093.0, "minX": 1.78955616E12, "maxY": 525424.25, "series": [{"data": [[1.78955622E12, 317007.5333333333], [1.78955616E12, 525424.25]], "isOverall": false, "label": "Bytes received per second", "isController": false}, {"data": [[1.78955622E12, 159093.0], [1.78955616E12, 263688.75]], "isOverall": false, "label": "Bytes sent per second", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.78955622E12, "title": "Bytes Throughput Over Time"}},
        getOptions : function(){
            return {
                series: {
                    lines: {
...
var responseTimesOverTimeInfos = {
        data: {"result": {"minY": 6.027193992917821, "minX": 1.78955616E12, "maxY": 6.2598715845448965, "series": [{"data": [[1.78955622E12, 6.2598715845448965], [1.78955616E12, 6.027193992917821]], "isOverall": false, "label": "GET dostępne urządzenia", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.78955622E12, "title": "Response Time Over Time"}},
        getOptions: function(){
            return {
                series: {
                    lines: {
...
var latenciesOverTimeInfos = {
        data: {"result": {"minY": 6.02631511583263, "minX": 1.78955616E12, "maxY": 6.259334163036722, "series": [{"data": [[1.78955622E12, 6.259334163036722], [1.78955616E12, 6.02631511583263]], "isOverall": false, "label": "GET dostępne urządzenia", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.78955622E12, "title": "Latencies Over Time"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var connectTimeOverTimeInfos = {
        data: {"result": {"minY": 0.0, "minX": 1.78955616E12, "maxY": 8.532787234950252E-5, "series": [{"data": [[1.78955622E12, 0.0], [1.78955616E12, 8.532787234950252E-5]], "isOverall": false, "label": "GET dostępne urządzenia", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.78955622E12, "title": "Connect Time Over Time"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var responseTimePercentilesOverTimeInfos = {
        data: {"result": {"minY": 0.0, "minX": 1.78955616E12, "maxY": 54.0, "series": [{"data": [[1.78955622E12, 21.0], [1.78955616E12, 54.0]], "isOverall": false, "label": "Max", "isController": false}, {"data": [[1.78955622E12, 4.0], [1.78955616E12, 0.0]], "isOverall": false, "label": "Min", "isController": false}, {"data": [[1.78955622E12, 7.0], [1.78955616E12, 7.0]], "isOverall": false, "label": "90th percentile", "isController": false}, {"data": [[1.78955622E12, 10.0], [1.78955616E12, 10.0]], "isOverall": false, "label": "99th percentile", "isController": false}, {"data": [[1